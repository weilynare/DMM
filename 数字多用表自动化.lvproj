...
<Project Type="Project" LVVersion="20008000">
	<Item Name="我的电脑" Type="My Computer">
		...
		<Item Name="子vi" Type="Folder">
			...
			<Item Name="Get Range Values.vi" Type="VI" URL="../../DMM/子vi/Get Range Values.vi"/>
			<Item Name="Get Rows Height.vi" Type="VI" URL="../../DMM/子vi/Get Rows Height.vi"/>
		</Item>
		...
		<Item Name="多功能校准源类lvlibp" Type="Folder" URL="../多功能校准源类lvlibp">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="数字多用表类lvlibp" Type="Folder" URL="../数字多用表类lvlibp">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="原始记录" Type="Folder" URL="../原始记录">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="ico" Type="Folder" URL="../Config/ico">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="接线图" Type="Folder" URL="../接线图">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		...
		<Item Name="依赖关系" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
				...
				<Item Name="Update Button.ctl" Type="VI" URL="/&lt;vilib&gt;/Retry/UI Control Suite/Boolean/System Buttons/Update Button.ctl"/>
				<Item Name="Excel Button.ctl" Type="VI" URL="/&lt;vilib&gt;/Retry/UI Control Suite/Boolean/System Buttons/Excel Button.ctl"/>
			...
			<Item Name="多功能校准源接口.lvclass" Type="LVClass" URL="../多功能校准源类lvlibp/Simulation Source/多功能校准源接口.lvlibp/多功能校准源接口/多功能校准源接口.lvclass"/>
			<Item Name="读取源换线.vi" Type="VI" URL="../多功能校准源类lvlibp/Simulation Source/多功能校准源接口.lvlibp/多功能校准源接口/属性访问/读取源换线.vi"/>
			<Item Name="数字多用表接口.lvclass" Type="LVClass" URL="../数字多用表类lvlibp/Simulation DMM/数字多用表接口.lvlibp/数字多用表接口/数字多用表接口.lvclass"/>
			<Item Name="读取表换线.vi" Type="VI" URL="../数字多用表类lvlibp/Simulation DMM/数字多用表接口.lvlibp/数字多用表接口/属性访问/读取表换线.vi"/>
			<Item Name="数字多用表接口.lvclass" Type="LVClass" URL="../数字多用表类lvlibp/34461A/数字多用表接口.lvlibp/数字多用表接口/数字多用表接口.lvclass"/>
			<Item Name="读取表换线.vi" Type="VI" URL="../数字多用表类lvlibp/34461A/数字多用表接口.lvlibp/数字多用表接口/属性访问/读取表换线.vi"/>
			<Item Name="读取测量参数.vi" Type="VI" URL="../数字多用表类lvlibp/34461A/数字多用表接口.lvlibp/数字多用表接口/属性访问/读取测量参数.vi"/>
			<Item Name="读取连线方式.vi" Type="VI" URL="../数字多用表类lvlibp/34461A/数字多用表接口.lvlibp/数字多用表接口/属性访问/读取连线方式.vi"/>
			<Item Name="读取VISA.vi" Type="VI" URL="../数字多用表类lvlibp/34461A/数字多用表接口.lvlibp/数字多用表接口/属性访问/读取VISA.vi"/>
		</Item>
		<Item Name="程序生成规范" Type="Build">
			<Item Name="数字多用表自动化程序" Type="EXE">
				...
				<Property Name="Destination[10].destName" Type="Str">数字多用表类lvlibp\Simulation DMM</Property>
				<Property Name="Destination[10].path" Type="Path">../exe/数字多用表类lvlibp\Simulation DMM</Property>
				<Property Name="Destination[10].path.type" Type="Str">relativeToProject</Property>
				<Property Name="Destination[11].destName" Type="Str">data\ico</Property>
				<Property Name="Destination[11].path" Type="Path">../exe/data/ico</Property>
				<Property Name="Destination[11].path.type" Type="Str">relativeToProject</Property>
				<Property Name="Destination[12].destName" Type="Str">接线图</Property>
				<Property Name="Destination[12].path" Type="Path">../exe/接线图</Property>
				...
				<Property Name="Destination[4].destName" Type="Str">多功能校准源类lvlibp</Property>
				<Property Name="Destination[4].path" Type="Path">../exe/多功能校准源类lvlibp</Property>
				<Property Name="Destination[4].path.type" Type="Str">relativeToProject</Property>
				<Property Name="Destination[5].destName" Type="Str">数字多用表类lvlibp</Property>
				<Property Name="Destination[5].path" Type="Path">../exe/数字多用表类lvlibp</Property>
				<Property Name="Destination[5].path.type" Type="Str">relativeToProject</Property>
				<Property Name="Destination[6].destName" Type="Str">多功能校准源类lvlibp\5720A</Property>
				<Property Name="Destination[6].path" Type="Path">../exe/多功能校准源类lvlibp\5720A</Property>
				<Property Name="Destination[6].path.type" Type="Str">relativeToProject</Property>
				<Property Name="Destination[7].destName" Type="Str">多功能校准源类lvlibp\Simulation Source</Property>
				<Property Name="Destination[7].path" Type="Path">../exe/多功能校准源类lvlibp\Simulation Source</Property>
				<Property Name="Destination[7].path.type" Type="Str">relativeToProject</Property>
				<Property Name="Destination[8].destName" Type="Str">数字多用表类lvlibp\34401A</Property>
				<Property Name="Destination[8].path" Type="Path">../exe/数字多用表类lvlibp\34401A</Property>
				<Property Name="Destination[8].path.type" Type="Str">relativeToProject</Property>
				<Property Name="Destination[9].destName" Type="Str">数字多用表类lvlibp\34461A</Property>
				<Property Name="Destination[9].path" Type="Path">../exe/数字多用表类lvlibp\34461A</Property>
				...
				<Property Name="Exe_iconItemID" Type="Ref">/我的电脑/ico/64X64.ico</Property>
				<Property Name="Source[0].itemID" Type="Str">{6E293111-0FB0-4B14-B692-00F66AF81C7A}</Property>
				...
				<Property Name="Source[10].itemID" Type="Ref">/我的电脑/多功能校准源类lvlibp/Simulation Source</Property>
				...
				<Property Name="Source[11].itemID" Type="Ref">/我的电脑/数字多用表类lvlibp/34401A</Property>
				...
				<Property Name="Source[12].itemID" Type="Ref">/我的电脑/数字多用表类lvlibp/34461A</Property>
				...
				<Property Name="Source[13].itemID" Type="Ref">/我的电脑/数字多用表类lvlibp/Simulation DMM</Property>
				...
				<Property Name="Source[14].destinationIndex" Type="Int">11</Property>
				<Property Name="Source[14].itemID" Type="Ref">/我的电脑/ico</Property>
				...
				<Property Name="Source[15].destinationIndex" Type="Int">12</Property>
				<Property Name="Source[15].itemID" Type="Ref">/我的电脑/接线图</Property>
				...
				<Property Name="Source[16].itemID" Type="Ref">/我的电脑/原始记录</Property>
				...
				<Property Name="Source[4].itemID" Type="Ref">/我的电脑/数字多用表接口.lvlibp</Property>
				<Property Name="Source[4].preventRename" Type="Bool">true</Property>
				<Property Name="Source[4].sourceInclusion" Type="Str">Include</Property>
				<Property Name="Source[5].destinationIndex" Type="Int">0</Property>
				<Property Name="Source[5].itemID" Type="Ref">/我的电脑/多功能校准源接口.lvlibp</Property>
				...
				<Property Name="Source[9].itemID" Type="Ref">/我的电脑/多功能校准源类lvlibp/5720A</Property>
			...
			<Item Name="数字多用表自动化安装程序" Type="Installer">
				<Property Name="Destination[0].name" Type="Str">数字多用表自动化</Property>
				<Property Name="Destination[0].parent" Type="Str">{3912416A-D2E5-411B-AFEE-B63654D690C0}</Property>
				<Property Name="Destination[0].tag" Type="Str">{71006945-15EF-4DFC-8F89-3C3485339CD9}</Property>
				...
				<Property Name="INST_buildSpecName" Type="Str">数字多用表自动化安装程序</Property>
				<Property Name="INST_defaultDir" Type="Str">{71006945-15EF-4DFC-8F89-3C3485339CD9}</Property>
				<Property Name="INST_installerName" Type="Str">install.exe</Property>
				<Property Name="INST_language" Type="Int">2052</Property>
				<Property Name="INST_productName" Type="Str">数字多用表自动化</Property>
				...
				<Property Name="MSI_distID" Type="Str">{4789052B-108C-48DB-A81D-93A5CD7DE77C}</Property>
				<Property Name="MSI_hideNonRuntimes" Type="Bool">true</Property>
				<Property Name="MSI_osCheck" Type="Int">0</Property>
				<Property Name="MSI_upgradeCode" Type="Str">{16CE86FD-1262-40E6-80C6-BE0A9142F922}</Property>
				<Property Name="RegDest[0].dirName" Type="Str">Software</Property>
				<Property Name="RegDest[0].dirTag" Type="Str">{DDFAFC8B-E728-4AC8-96DE-B920EBB97A86}</Property>
				<Property Name="RegDest[0].parentTag" Type="Str">2</Property>
				<Property Name="RegDestCount" Type="Int">1</Property>
				<Property Name="Source[0].dest" Type="Str">{71006945-15EF-4DFC-8F89-3C3485339CD9}</Property>
				<Property Name="Source[0].File[0].dest" Type="Str">{71006945-15EF-4DFC-8F89-3C3485339CD9}</Property>
				<Property Name="Source[0].File[0].name" Type="Str">数字多用表自动化程序.exe</Property>
				<Property Name="Source[0].File[0].tag" Type="Str">{DB3C849A-7EBD-46A8-93A8-3544B3D890C3}</Property>
				<Property Name="Source[0].FileCount" Type="Int">1</Property>
				<Property Name="Source[0].name" Type="Str">数字多用表自动化程序</Property>
				<Property Name="Source[0].tag" Type="Ref">/我的电脑/程序生成规范/数字多用表自动化程序</Property>
